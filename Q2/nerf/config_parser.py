...
def add_config_arguments(parser=None):
    if parser is None:
        parser = argparse.ArgumentParser(
            description="Add configuration for NeRF optimization using SDS loss."
        )

    parser.add_argument(
        "--h", type=int, default=64, help="render height for NeRF in training"
    )
    parser.add_argument(
        "--w", type=int, default=64, help="render width for NeRF in training"
    )
    parser.add_argument(
        "--dataset_size_train",
        type=int,
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.2,
        help="ratio of textureless shading",
    )
    parser.add_argument(
        "--use_ema",
        type=int,
    ...
    ### dataset options
    parser.add_argument(
        "--min_near", type=float, default=0.01, help="minimum near distance for camera"
    )
    parser.add_argument(
        "--radius_range",
        type=float,
    ...
    parser.add_argument(
        "--default_radius", type=float, default=3.2, help="radius for the default view"
    )
    parser.add_argument(
        "--default_polar", type=float, default=90, help="polar for the default view"
    )
    parser.add_argument(
        "--default_azimuth", type=float, default=0, help="azimuth for the default view"
    )
    parser.add_argument(
        "--default_fovy", type=float, default=20, help="fovy for the default view"
    )
    ...
    )  # 4096, tune it down if you have OOM
